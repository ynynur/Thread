...
public class AsansorThread extends Thread{
    ...
    private int id;
    private int asansorKat=0; //bulungugu kat
    private int varisKat;
    private int yolcuSayisi=0;
    private boolean gidisat;
    private boolean aktif=false;
    private int kapasite=10;
    private Avm avm;

    private ArrayList<Person> asansordekiler = new ArrayList<Person>(); //asansördekileri tutan array list
    ...
    public AsansorThread(int id) {
        gidisat=true;
        this.id=id;
    }

    public AsansorThread(int id , Avm avm){
        this.varisKat =0;
        gidisat=true;
        this.id=id;
        this.avm=avm;
